...
class OrderLib:
    def __init__(self, ip) -> None:
        ...
        #self.rbk =rbk.rbklib.rbklib(self.tcp_ip, True)
    ...
    def get(self,url:str):
        r = requests.get(self.ip + url, headers=_orderLif_headers)
        return r.json()
        pass
    def post(self,url:str,data:any):
        datas=json.dumps(data if data is not None else {})
        r = requests.post(self.ip + url, data=datas, headers=_orderLif_headers)
        return r.json()
        pass
